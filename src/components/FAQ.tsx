...
const FAQ = () => {
  ...
  const faqData = [
      ...
      answer:"للإستشارات يمكنك حجز موعد من خلال ملئ نموذج الاستشارة المتاح على الموقع.  ولغير ذلك تواصل مع الدعم الفني"    },
    {
      ...
      answer: "الموقع يعمل على مدار الساعة. \
للاستشارات الشخصية الخاصة، قم بتعبئة النموذج المخصص وسيتم التواصل معك للتعرف على المشكلة، ثم تحديد موعد مقابلة من خلال أحد تطبيقات المحادثة.\
لمراجعي البروفيسور عبدالله السبيعي قم بتعبئة النموذج المخصص لذلك."
    },
    {
