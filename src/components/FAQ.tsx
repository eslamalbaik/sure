  ...
  const faqData = [
    {
      ...
      answer: "عملنا في شور لا علاقة له بالطب والأدوية  والعلاج . ما نقدمه هو استشارة شخصية خاصة في مجالات العلاقات العملية والزوجية او الأسرية ، كما نقدم الإستشارات في التربية والتعامل مع ضغوط الحياة وتجاوز الأزمات نقدم خداماتنا في سرية كاملة فلا نطلب اسمك ولا رقمك  فقط اسم رمزي وايميل للتواصل"
      // "نقدم استشارات طبية متخصصة في مختلف المجالات الطبية، بما في ذلك الاستشارات العامة والتخصصية، مع توفير الإرشادات الطبية المناسبة لكل حالة."
    },
    {
    ...
    },
    {
      ...
      answer: "الموقع مفتوح على مدار الساعة ، للاستشارات الشخصية الخاصة ، قم بتعبئة النموذج وسيتم التواصل معك للتعرف على المشكلة ، ثم تحديد موعد مقابلة زوم أو ما شابه"
    },
    {
    ...
    },
    {
      ...
      answer: "سنقدم لك لقاءا تعريفيا للتعرف  على موضوع الاستشارة أولا ، ثم نقوم بعدها بإرسال اتفاقية  العمل معا وفيها المسار المناسب لك من بين 3 مسارات استشارية لك  متاحة ، وفيها رسوم"
    },
    {
      question: "هل يمكنني الحصول على تقرير طبي؟",
      answer: "عملنا يقتصر على الاستشارات في مجالات العلاقات العامة  أو لسنا مخولين بالعلاج او تقديم التقارير الطبية  ، اما لمراجعي الدكتور عبد الله السبيعي يمكنك تقديم ذلك من خلال مركز إدراك الطبي"
    }
  ];
